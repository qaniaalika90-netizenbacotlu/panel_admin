...
import { listDeposits, approveDeposit, rejectDeposit } from "../lib/api";
...
export default function Deposits() {
  ...
  const doApprove = async (id) => { await approveDeposit(id); load(); };
  const doReject  = async (id) => { await rejectDeposit(id);  load(); };

  return (
    <section>
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-xl font-semibold text-gold">Deposits</h2>
